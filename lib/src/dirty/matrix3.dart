...
class Matrix3 implements Mutable<MutableMatrix3> {
  ...
  double determinant() {
    final x = _storage[0] * ((_storage[4] * _storage[8]) - (_storage[5] * _storage[7]));
    final y = _storage[1] * ((_storage[3] * _storage[8]) - (_storage[5] * _storage[6]));
    final z = _storage[2] * ((_storage[3] * _storage[7]) - (_storage[4] * _storage[6]));
    return x - y + z;
  }
...
extension type MutableMatrix3(Matrix3 matrix) {
  ...
  void transposeMultiply(Matrix3 arg) {
    ...
    final argStorage = arg._storage;
    storage[0] = (m00 * argStorage[0]) + (m01 * argStorage[1]) + (m02 * argStorage[2]);
    storage[3] = (m00 * argStorage[3]) + (m01 * argStorage[4]) + (m02 * argStorage[5]);
    storage[6] = (m00 * argStorage[6]) + (m01 * argStorage[7]) + (m02 * argStorage[8]);
    storage[1] = (m10 * argStorage[0]) + (m11 * argStorage[1]) + (m12 * argStorage[2]);
    storage[4] = (m10 * argStorage[3]) + (m11 * argStorage[4]) + (m12 * argStorage[5]);
    storage[7] = (m10 * argStorage[6]) + (m11 * argStorage[7]) + (m12 * argStorage[8]);
    storage[2] = (m20 * argStorage[0]) + (m21 * argStorage[1]) + (m22 * argStorage[2]);
    storage[5] = (m20 * argStorage[3]) + (m21 * argStorage[4]) + (m22 * argStorage[5]);
    storage[8] = (m20 * argStorage[6]) + (m21 * argStorage[7]) + (m22 * argStorage[8]);
  }
  ...
  void multiplyTranspose(Matrix3 arg) {
    ...
    final m20 = storage[2], m21 = storage[5], m22 = storage[8];
    final argStorage = arg._storage;
    storage[0] = (m00 * argStorage[0]) + (m01 * argStorage[3]) + (m02 * argStorage[6]);
    storage[3] = (m00 * argStorage[1]) + (m01 * argStorage[4]) + (m02 * argStorage[7]);
    storage[6] = (m00 * argStorage[2]) + (m01 * argStorage[5]) + (m02 * argStorage[8]);
    storage[1] = (m10 * argStorage[0]) + (m11 * argStorage[3]) + (m12 * argStorage[6]);
    storage[4] = (m10 * argStorage[1]) + (m11 * argStorage[4]) + (m12 * argStorage[7]);
    storage[7] = (m10 * argStorage[2]) + (m11 * argStorage[5]) + (m12 * argStorage[8]);
    storage[2] = (m20 * argStorage[0]) + (m21 * argStorage[3]) + (m22 * argStorage[6]);
    storage[5] = (m20 * argStorage[1]) + (m21 * argStorage[4]) + (m22 * argStorage[7]);
    storage[8] = (m20 * argStorage[2]) + (m21 * argStorage[5]) + (m22 * argStorage[8]);
  }
  ...
  double copyInverse(Matrix3 arg) {
    ...
    final argStorage = arg._storage;
    final ix = invDet * (argStorage[4] * argStorage[8] - argStorage[5] * argStorage[7]);
    final iy = invDet * (argStorage[2] * argStorage[7] - argStorage[1] * argStorage[8]);
    final iz = invDet * (argStorage[1] * argStorage[5] - argStorage[2] * argStorage[4]);
    final jx = invDet * (argStorage[5] * argStorage[6] - argStorage[3] * argStorage[8]);
    final jy = invDet * (argStorage[0] * argStorage[8] - argStorage[2] * argStorage[6]);
    final jz = invDet * (argStorage[2] * argStorage[3] - argStorage[0] * argStorage[5]);
    final kx = invDet * (argStorage[3] * argStorage[7] - argStorage[4] * argStorage[6]);
